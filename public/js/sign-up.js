// this is a function that will take the values from the username, email and password inputs
// then sends those values in a POST request to add a new user --
// if successfull, it will replace location with the dashboard
